  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interbotix_xs_msgs__srv__OperatingModes_Request;
    is_plain =
      (
...
static size_t _OperatingModes_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interbotix_xs_msgs__srv__OperatingModes_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interbotix_xs_msgs__srv__OperatingModes_Response;
    is_plain =
      (
...
static size_t _OperatingModes_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interbotix_xs_msgs__srv__OperatingModes_Response(
    full_bounded, is_plain, 0);
