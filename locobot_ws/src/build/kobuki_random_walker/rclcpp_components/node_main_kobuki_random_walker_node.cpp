...
#define NODE_MAIN_LOGGER_NAME "kobuki_random_walker_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libkobuki_random_walker.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<kobuki_random_walker::RandomWalkerNode>";
