...
#define NODE_MAIN_LOGGER_NAME "openni2_camera_driver"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libopenni2_camera_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<openni2_wrapper::OpenNI2Driver>";
