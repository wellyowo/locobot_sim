...
static const _GetSerial_Request_type_support_symbol_names_t _GetSerial_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, openni2_camera, srv, GetSerial_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, openni2_camera, srv, GetSerial_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, openni2_camera, srv, GetSerial_Request)() {
  return &::openni2_camera::srv::rosidl_typesupport_c::GetSerial_Request_message_type_support_handle;
}
...
static const _GetSerial_Response_type_support_symbol_names_t _GetSerial_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, openni2_camera, srv, GetSerial_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, openni2_camera, srv, GetSerial_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, openni2_camera, srv, GetSerial_Response)() {
  return &::openni2_camera::srv::rosidl_typesupport_c::GetSerial_Response_message_type_support_handle;
}
...
static const _GetSerial_type_support_symbol_names_t _GetSerial_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, openni2_camera, srv, GetSerial)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, openni2_camera, srv, GetSerial)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, openni2_camera, srv, GetSerial)() {
  return &::openni2_camera::srv::rosidl_typesupport_c::GetSerial_service_type_support_handle;
}
