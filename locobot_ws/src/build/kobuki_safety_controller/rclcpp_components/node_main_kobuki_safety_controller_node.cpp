...
#define NODE_MAIN_LOGGER_NAME "kobuki_safety_controller_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libkobuki_safety_controller.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<kobuki_safety_controller::SafetyController>";
