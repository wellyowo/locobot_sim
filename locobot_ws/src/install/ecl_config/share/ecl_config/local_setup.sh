...
: ${AMENT_CURRENT_PREFIX:="/home/wellyowo/locobot_sim/locobot_ws/src/install/ecl_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ecl_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ecl_config/environment/path.sh"
