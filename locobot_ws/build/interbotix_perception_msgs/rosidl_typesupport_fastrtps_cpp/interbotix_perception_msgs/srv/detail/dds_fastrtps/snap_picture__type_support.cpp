...
#include "interbotix_perception_msgs/srv/detail/snap_picture__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interbotix_perception_msgs::srv::SnapPicture_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interbotix_perception_msgs::srv::SnapPicture_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interbotix_perception_msgs::srv::SnapPicture_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SnapPicture_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interbotix_perception_msgs::srv::SnapPicture_Request *>(
...
static size_t _SnapPicture_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_SnapPicture_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SnapPicture_Request__callbacks = {
...
static rosidl_message_type_support_t _SnapPicture_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SnapPicture_Request__callbacks,
...
{
  return &interbotix_perception_msgs::srv::typesupport_fastrtps_cpp::_SnapPicture_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interbotix_perception_msgs::srv::SnapPicture_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interbotix_perception_msgs::srv::SnapPicture_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interbotix_perception_msgs::srv::SnapPicture_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SnapPicture_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interbotix_perception_msgs::srv::SnapPicture_Response *>(
...
static size_t _SnapPicture_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_SnapPicture_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SnapPicture_Response__callbacks = {
  "interbotix_perception_msgs::srv",
...
static rosidl_message_type_support_t _SnapPicture_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SnapPicture_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &interbotix_perception_msgs::srv::typesupport_fastrtps_cpp::_SnapPicture_Response__handle;
}
...
static service_type_support_callbacks_t _SnapPicture__callbacks = {
  "interbotix_perception_msgs::srv",
  "SnapPicture",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interbotix_perception_msgs, srv, SnapPicture_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interbotix_perception_msgs, srv, SnapPicture_Response)(),
...
static rosidl_service_type_support_t _SnapPicture__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SnapPicture__callbacks,
...
{
  return &interbotix_perception_msgs::srv::typesupport_fastrtps_cpp::_SnapPicture__handle;
}
