...
#define NODE_MAIN_LOGGER_NAME "kobuki_keyop_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libkobuki_keyop.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<kobuki_keyop::KeyOp>";
