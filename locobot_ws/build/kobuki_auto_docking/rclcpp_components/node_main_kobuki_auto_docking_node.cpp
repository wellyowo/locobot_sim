...
#define NODE_MAIN_LOGGER_NAME "kobuki_auto_docking_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libkobuki_auto_docking.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<kobuki_auto_docking::AutoDockingROS>";
