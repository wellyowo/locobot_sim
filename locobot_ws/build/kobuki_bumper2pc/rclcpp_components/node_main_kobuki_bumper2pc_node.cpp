...
#define NODE_MAIN_LOGGER_NAME "kobuki_bumper2pc_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libkobuki_bumper2pc.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<kobuki_bumper2pc::Bumper2PcNode>";
