...
#define NODE_MAIN_LOGGER_NAME "kobuki_ros_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libkobuki_ros.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<kobuki_node::KobukiRos>";
